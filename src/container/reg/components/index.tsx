...
import BaseController from 'src/framework/controller';
                ...
                <Card title="新用户注册1" style={{ borderBottom: 0 }}>
                    <div className="p-reg">
                        <Form onFinish={this.handleSubmit} className="reg-form">
                            <Form.Item {...formItemLayout} label="昵称" name="nick" rules={[{ required: true, message: '请输入昵称' }]}>
                                <Input placeholder="方便人员查找" maxLength={16}/>
                            </Form.Item>
                            <Form.Item {...formItemLayout} label="密码" name="password" rules={[{ required: true, min: 8, message: '请输入正确密码,密度大于8位' }]}>
